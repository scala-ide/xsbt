...
private object VersionComp {
	val versionMap = Map(
	    "scalacheck" -> Map("2.8.1" -> "1.8", 
	    					"2.8.2" -> "1.8", 
	    		   "2.8.3-SNAPSHOT" -> "1.8", 
	    		   			"2.9.1" -> "1.9", 
	    		   	    "2.10.0-M3" -> "1.9",
	    		  "2.10.0-SNAPSHOT" -> "1.9"),
	    "sbinary" -> Map("2.8.1" -> "0.4.0",
	    				 "2.8.2" -> "0.4.0",
	    	    "2.8.3-SNAPSHOT" -> "0.4.0",
	    	    		 "2.9.0" -> "0.4.0",
	    	    		 "2.9.1" -> "0.4.0",
	    	    	 "2.10.0-M3" -> "0.4.0",
	    	   "2.10.0-SNAPSHOT" -> "0.4.0"),
	    "sxr" -> Map("2.8.1" -> "0.2.7", 
	    			 "2.8.2" -> "0.2.7",
	        "2.8.3-SNAPSHOT" -> "0.2.7", 
	        		 "2.9.1" -> "0.2.8-SNAPSHOT", 
    	    	 "2.10.0-M3" -> "0.2.8-SNAPSHOT",
	       "2.10.0-SNAPSHOT" -> "0.2.8-SNAPSHOT")
	    )
}
